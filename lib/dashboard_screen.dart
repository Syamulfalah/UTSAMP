  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 33, 45, 12),
      ),
      body: Container(
          ...
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: const Color.fromARGB(255, 165, 85, 85), width: 4),
              ),
...
class DashboardIcon extends StatelessWidget {
  ...
  DashboardIcon({
    ...
    this.iconColor = const Color.fromARGB(255, 5, 10, 14), // Warna ikon default adalah hitam
  });
